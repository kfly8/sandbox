...
import type { OpenApiTypes } from './sources/OpenAPI/types';
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getBookById?: Resolver<Maybe<ResolversTypes['Book']>, ParentType, ContextType, RequireFields<QuerygetBookByIdArgs, 'bookId'>>;
}>;
...
export type MeshContext = OpenApiTypes.Context & BaseMeshContext;
